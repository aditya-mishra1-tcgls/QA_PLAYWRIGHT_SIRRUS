...
Lead Report covers report dashboard setup for engagement users, including creating a dashboard, attaching chart access, and saving a chart into the newly created dashboard.
...
| --- | --- | --- | --- | --- | --- |
| LREP-001 | Create dashboard and chart from Reports Dashboard, then delete generated dashboard | fresh | Dashboard and chart save successfully, deletion succeeds, and dashboard is removed from the list | Automated | `tests/flows/lead-report/create-dashboard-and-chart.spec.ts` |
