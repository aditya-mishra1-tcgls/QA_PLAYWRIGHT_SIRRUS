...
- project defaults to active project from environment config
...
| --- | --- | --- | --- | --- | --- |
| LEAD-001 | Create lead from Manage Leads | fresh | New lead saved and searchable | Automated | `tests/flows/lead-management/lead-creation.spec.ts` |
